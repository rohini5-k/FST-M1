...
public class Activity6_PopupLogin {
	AppiumDriver driver;
	WebDriverWait wait;
	...
	@Test(priority=1)
	public void popupLoginValid() throws InterruptedException{
		...
		Thread.sleep(2000);
		driver.findElement(AppiumBy.xpath("//android.view.View/android.widget.EditText[@resource-id=\"username\"]")).sendKeys("admin");
		driver.findElement(AppiumBy.xpath("//android.view.View/android.widget.EditText[@resource-id=\"password\"]")).sendKeys("password");
	...
	@Test(priority=2)
	public void popupLoginInvalid() throws InterruptedException{
